#tag Class
Protected Class UIControlEvent
	#tag Method, Flags = &h0
		Shared Function All() As UIControlEvent
		  return new UIControlEvent (&hFFFFFFFF)
		End Function
	#tag EndMethod

	#tag Method, Flags = &h0
		Shared Function AllEditingEvents() As UIControlEvent
		  return new UIControlEvent (&h000F0000)
		End Function
	#tag EndMethod

	#tag Method, Flags = &h0
		Shared Function AllTouchEvents() As UIControlEvent
		  return new UIControlEvent (&h0FFF)
		End Function
	#tag EndMethod

	#tag Method, Flags = &h0
		Shared Function ApplicationReserved() As UIControlEvent
		  return new UIControlEvent (&h0F000000)
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Shared Function SystemReserved() As UIControlEvent
		  return new UIControlEvent (&hF0000000)
		End Function
	#tag EndMethod
