...
Inherits AppleCAMediaTimingObject
	#tag Method, Flags = &h1000
		Sub Constructor()
		  declare function animation lib QuartzCoreLib selector "animation" (id as ptr) as ptr
	...
	#tag Method, Flags = &h0
		Function DefaultValueForKey(Key As CFStringRef) As AppleObject
		  declare function defaultValueForKey lib QuartzCoreLib selector "defaultValueForKey:" (id as ptr, key as CFStringRef) as Ptr
		  return AppleObject.MakeFromPtr (defaultValueForKey(id, key))
	...
	#tag Method, Flags = &h0
		Shared Function MakeFromPtr(aPtr as Ptr) As AppleCAAnimation
		  return if (aptr <> NIL, new AppleCAAnimation (aptr), NIL)
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Function ShouldArchiveValueForKey(Key As CFStringRef) As Boolean
		  ...
		  declare function shouldArchiveValueForKey lib QuartzCoreLib selector "shouldArchiveValueForKey:" (id as ptr, key as CFStringRef) as Boolean
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function removedOnCompletion lib QuartzCoreLib selector "isRemovedOnCompletion" (id as ptr) as Boolean
		...
		#tag Setter
			Set
			  declare Sub setremovedOnCompletion lib QuartzCoreLib selector "setRemovedOnCompletion:" (id as ptr, value as Boolean)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare Function timingFunction lib QuartzCoreLib selector "timingFunction" (id as ptr) as ptr
			  dim myptr as ptr = timingFunction (id)
			  return if (myptr <> NIL, new AppleCAMediaTimingFunction (timingFunction (id)), NIL)
