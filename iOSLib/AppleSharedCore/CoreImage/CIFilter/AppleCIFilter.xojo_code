...
Inherits AppleObject
	...
	#tag ComputedProperty, Flags = &h0
		...
		#tag Setter
			Set
			  if InputKeys.ContainsText (kCIInputAngleKey) then setValueForKey (kCIInputAngleKey, new applenumber(value))
			End Set
		#tag EndSetter
	...
	#tag ComputedProperty, Flags = &h0
		...
		#tag Setter
			Set
			  if InputKeys.ContainsText (kCIInputAspectRatioKey) then setValueForKey (kCIInputAspectRatioKey, new applenumber(value))
			End Set
		#tag EndSetter
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  if InputKeys.ContainsText (kCIInputBackgroundImageKey) then return AppleCIImage.MakeFromPtr (ValueForKey (kCIInputBackgroundImageKey))
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  if InputKeys.ContainsText (kCIInputBackgroundImageKey) then setValueForKey (kCIInputBackgroundImageKey, value)
			End Set
		#tag EndSetter
	...
	#tag ComputedProperty, Flags = &h0
		...
		#tag Setter
			Set
			  if InputKeys.ContainsText (kCIInputBrightnessKey) then setValueForKey (kCIInputBrightnessKey, new applenumber(value))
			End Set
		#tag EndSetter
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  if InputKeys.ContainsText (kCIInputColorKey) then  return AppleCIcolor.MakeFromPtr (ValueForKey (kCIInputColorKey))
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  if InputKeys.ContainsText (kCIInputColorKey) then setValueForKey (kCIInputColorKey, value)
			End Set
		#tag EndSetter
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  return AppleCIImage.MakeFromPtr (ValueForKey (kCIInputImageKey))
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  if InputKeys.ContainsText (kCIInputImageKey) then setValueForKey (kCIInputImageKey, value)
			End Set
		#tag EndSetter
	...
	#tag ComputedProperty, Flags = &h0
		...
		#tag Setter
			Set
			  if InputKeys.ContainsText (kCIInputContrastKey) then setValueForKey (kCIInputContrastKey, new applenumber(value))
			End Set
		#tag EndSetter
	...
	#tag ComputedProperty, Flags = &h0
		...
		#tag Setter
			Set
			  if InputKeys.ContainsText (kCIInputEVKey) then setValueForKey (kCIInputEVKey, new applenumber(value))
			End Set
		#tag EndSetter
		InputEV As double
	#tag EndComputedProperty
	...
	#tag ComputedProperty, Flags = &h0
		...
		#tag Setter
			Set
			  if InputKeys.ContainsText (kCIInputIntensityKey) then setValueForKey (kCIInputIntensityKey, new applenumber(value))
			End Set
		#tag EndSetter
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  if InputKeys.ContainsText (kCIInputMaskImageKey) then return AppleCIImage.MakeFromPtr (ValueForKey (kCIInputMaskImageKey))
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  if InputKeys.ContainsText (kCIInputMaskImageKey) then setValueForKey (kCIInputMaskImageKey, value)
			End Set
		#tag EndSetter
	...
	#tag ComputedProperty, Flags = &h0
		...
		#tag Setter
			Set
			  if InputKeys.ContainsText (kCIInputRadiusKey) then setValueForKey (kCIInputRadiusKey, new applenumber(value))
			End Set
		#tag EndSetter
	...
	#tag ComputedProperty, Flags = &h0
		...
		#tag Setter
			Set
			  if InputKeys.ContainsText (kCIInputSaturationKey) then setValueForKey (kCIInputSaturationKey, new applenumber(value))
			End Set
		#tag EndSetter
	...
	#tag ComputedProperty, Flags = &h0
		...
		#tag Setter
			Set
			  if InputKeys.ContainsText (kCIInputScaleKey) then setValueForKey (kCIInputScaleKey, new applenumber(value))
			End Set
		#tag EndSetter
	...
	#tag ComputedProperty, Flags = &h0
		...
		#tag Setter
			Set
			  if InputKeys.ContainsText (kCIInputSharpnessKey) then setValueForKey (kCIInputSharpnessKey, new applenumber(value))
			End Set
		#tag EndSetter
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  if InputKeys.ContainsText (kCIInputTargetImageKey) then return AppleCIImage.MakeFromPtr (ValueForKey (kCIInputTargetImageKey))
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  if InputKeys.ContainsText (kCIInputTargetImageKey) then setValueForKey (kCIInputTargetImageKey, value)
			End Set
		#tag EndSetter
	...
	#tag ComputedProperty, Flags = &h0
		...
		#tag Setter
			Set
			  if InputKeys.ContainsText (kCIInputTimeKey) then setValueForKey (kCIInputTimeKey, new applenumber(value))
			End Set
		#tag EndSetter
		InputTime As double
	#tag EndComputedProperty
	...
	#tag ComputedProperty, Flags = &h0
		...
		#tag Setter
			Set
			  if InputKeys.ContainsText (kCIInputTransformKey) then setCGAffineTransformForKey (kCIInputTransformKey, value)
			End Set
		#tag EndSetter
	...
	#tag ComputedProperty, Flags = &h0
		...
		#tag Setter
			Set
			  if InputKeys.ContainsText (kCIInputVersionKey) then setValueForKey (kCIInputVersionKey, new applenumber(value))
			End Set
		#tag EndSetter
	...
	#tag ComputedProperty, Flags = &h0
		...
		#tag Setter
			Set
			  if InputKeys.ContainsText (kCIInputWidthKey) then setValueForKey (kCIInputWidthKey, new applenumber(value))
			End Set
		#tag EndSetter
