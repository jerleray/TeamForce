...
Inherits NSObject
	...
	#tag Method, Flags = &h0
		Function ColorValue() As Color
		  ...
		  declare function getComponents lib UIKit selector "getRed:green:blue:alpha:" (obj_id as ptr, byref red as Single, byref green as Single, byref blue as Single, byref alpha as Single) as Boolean
